...
(./$exename $data_folder$1 ./temp/Res-[$1\_EPS=$Epsilon\_L=$Lvl\_D=$Dict\_d=$Decay\_S=$Sup\_B=$Batch\_c=$Carry].res -m$m -M$M -e$Epsilon -c$Carry -L$Lvl -B$Batch -D$Dict -p2 -d$Decay -s$Sup>temp1) & (./calc_mem.sh > temp2)
cat temp2 >> temp1
